...
namespace Minipede.Gameplay.LevelPieces
{
	...
	{
		public float PollutionPercentage => 1f - (_cleansedCells.Count / (float)_pollutionArea);
		...
		public virtual void Cleanse( Bounds bounds )
		{
			...
			{
				CanWin = PollutionPercentage <= _pollutionWinPercentage.PollutionWinPercentage,
